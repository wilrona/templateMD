<?php
/* Template Name: Page de souscription */
        ...
        <aside class="col-lg-3">
            ...
            <div class="entry card">
                <div class="entry__body card__body">
                    {% include 'menu_member.twig' %}
                </div>
            </div>

        </aside> <!-- end sidebar -->
        <!-- Posts -->
        <div class="col-lg-9 col-12 blog__content">

            <div class="entry card">

                <article class="entry__body post-list__body card__body post-type-{{post.post_type}}" id="post-{{post.ID}}">
...
<form id="rcp_registration_form" class="rcp_form" method="POST" action="<?php echo esc_url( rcp_get_current_url() ); ?>">
    ...
    <p id="rcp_submit_wrap">
        ...
        <input type="submit" name="rcp_submit_registration" id="rcp_submit" class="rcp-button" value="<?php __( 'Payer votre abonnement', 'rcp' ); ?>"/>
    </p>
</form>
